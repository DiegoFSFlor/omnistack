...
export default function Detail() {
  ...
  const message = `Olá ${incident.name}, estou entrando em contato, pois gostaria de ajudar no caso ${incident.title} com um valor de ${incident.value} `;
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contactBox}>
        ...
        <Text style={styles.heroTitle}>Seja o Heroe deste caso.</Text>
